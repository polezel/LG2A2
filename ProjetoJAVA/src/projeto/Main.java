...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        lucas.adicionaTransacao(Tipo_Transacao.RECEITA, new BigDecimal("500.00"), "Transferência Recebida", 1);
        ...
        lucas.adicionaTransacao(Tipo_Transacao.DESPESA, new BigDecimal("200.00"), "Transferência Itaú", 3);
